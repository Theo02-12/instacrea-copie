...
export default function SearchFilter({children}: Props) {
  ...
  return (
    ...
    >
      <div className="md:border-r md:border-b-0 border-b border-gray-700 p-4 md:space-y-4 md:block flex space-x-8 md:space-x-0 sticky top-0 md:h-screen z-10 md:z-0 bg-white">
        <div>
        ...
        <div>
          <button type="submit" className="text-blue-gray-600 text-center w-full p-1 border rounded mt-6">
            Filtrer
          </button>
          <button onClick={() => {
            setRating([0, 5])
          ...
          }} type="button" className="text-blue-gray-600 text-center w-full p-1 border rounded mt-6">
            Reset
          </button>
        </div>
      </div>
